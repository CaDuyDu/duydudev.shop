			...
			<div class="header-grid">
				...
				<div class="header-left animated wow fadeInLeft" data-wow-delay=".5s">
					...
					<li><i class="glyphicon glyphicon-headphones"></i><a href="#">24x7 live support</a></li>
						<li><i class="glyphicon glyphicon-envelope" ></i><a href="">ducd.kma@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" ></i>+84 941 463 409</li>
					...
					<div class="navbar-header nav_2">
						<button type="button" class="navbar-toggle collapsed navbar-toggle1" data-toggle="collapse" data-target="#bs-megadropdown-tabs">
						 ...
						 <div class="navbar-brand logo-nav-left ">
							<h1 class="animated wow pulse" data-wow-delay=".5s"><a href="index.html">Fashions<span>Start</span></a></h1>
						</div>
		...
		<div class="clearfix"> </div>
			...
			<div class="footer-grids">
				...
				<div class="col-md-4 footer-grid animated wow fadeInLeft" data-wow-delay=".6s">
					<h3>Contact Info</h3>
					<ul>
						<li><i class="glyphicon glyphicon-map-marker" ></i>Dien Bien<span>Dien Bien City</span></li>
						<li class="foot-mid"><i class="glyphicon glyphicon-envelope" ></i><a href="mailto:info@example.com">ducd.kma@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" ></i>+84 941 463 409</li>
					</ul>
				</div>
			...
			<div class="copy-right animated wow fadeInUp" data-wow-delay=".5s">
				<p>&copy 2018 Classic Style. All rights reserved | Design by Duy Dự</p>
			</div>
		</div>
	</div>
<!-- //footer -->
