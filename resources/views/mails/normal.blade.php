...
<div style="width: 50%; margin: auto; background-color: white;padding: 10px;">
    ...
    <div style="padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto;">
        ...
        <p>Bạn cần được hỗ trợ ngay? chỉ cần truy cập <a href="https://www.facebook.com/quang.peter.7" class="text-success">Duy Dự Facebook</a>, hoặc gọi số điện thoại <label class="text-success">0941463409</label> (8-21h cả ngày T7, CN). Đội ngũ Shop.zent luôn sẵn sàng hỗ trợ bạn bất kì lúc nào.</p>
